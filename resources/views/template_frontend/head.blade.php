...
<head>
	...
	<title>SIPRO - Sistem Informasi Prodi</title>
			...
			<div id="nav-top">
				<div class="container">
					...
					<ul class="nav-social">
						...
						<li><a href="https://api.whatsapp.com/send?phone=6285156001102"><i class="fa fa-whatsapp"></i></a></li>
						<li><a href="https://www.youtube.com/"><i class="fa fa-youtube"></i></a></li>
						<li><a href="https://www.instagram.com/raza_gopo/"><i class="fa fa-instagram"></i></a></li>
					</ul>
					<!-- /social -->

					<!-- logo -->
					<div class="nav-logo">
						<a href="/" class="logo"><img src="{{ asset('img/logo-ti.png') }}" alt=""></a>
					</div>
					<!-- /logo -->
